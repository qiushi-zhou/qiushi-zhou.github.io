---
layout: post
title: "例外状态 | State of Exception"
comments: false
description: "A philosophical essay in two languages — on the rupture of normality, from Heidegger to Agamben, from Bayesian priors to Kubrick's nightmares."
keywords: "Agamben, Heidegger, Foucault, state of exception, 阿甘本, 海德格尔, 福柯, 例外状态, Simondon, Stiegler, Yuk Hui"
---

<div class="bilingual-post">

<!-- 01 — Popular literature -->
<div class="bilingual-section">
<div class="bilingual-col bilingual-col-cn" markdown="1">
### 大众文学
...
<!-- 03 — Choose a fucking big television -->
<div class="bilingual-section">
<div class="bilingual-col bilingual-col-cn" markdown="1">
...
<!-- 06 — Disease / violence / social disorder -->
<div class="bilingual-section">
<div class="bilingual-col bilingual-col-cn" markdown="1">
### 疾病 / 暴力 / 社会失序
...
<!-- 19 — Modern complexity vs antiquity -->
<div class="bilingual-section">
<div class="bilingual-col bilingual-col-cn" markdown="1">
### 现代社会的复杂性 vs 远古时期
...
<!-- 21 — AI dissolving functional value -->
<div class="bilingual-section">
<div class="bilingual-col bilingual-col-cn" markdown="1">
### AI 消解功能性价值 / 参禅式的行为
